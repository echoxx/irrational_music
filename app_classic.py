"""Classic (pre-revision) Gradio UI, kept for A/B comparison with app.py.

Run with: ./run_ui_classic.sh  (serves on port 7861 so it can run alongside the new UI)
"""
...
with gr.Blocks(title="Irrational Sonification (classic)") as demo:
    gr.Markdown(
        "# Irrational number sonification — classic UI\n"
